...
import rotasProdutos from "./routes/routes_produtos.js";
import rotasCampanha from "./routes/routes_campanha.js";
import rotasEntrada from "./routes/routes_entrada.js";

const NOME_SERVICO = process.env.NOME_SERVICO || "miguel-produtos";
...
app.get("/", (req, res) => {
  res.json({
    ...
    descricao:
      "API de Produtos, Entradas de estoque e Campanhas do Mercadinho São Miguel",
    rotas: ["/produtos", "/entrada", "/campanha", "/health"],
  });
});
