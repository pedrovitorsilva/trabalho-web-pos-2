...
const NOME_SERVICO = process.env.NOME_SERVICO || "miguel-vendas";
...
app.get("/", (req, res) => {
  res.json({
    ...
    descricao:
      "API de Vendas, Pagamentos e Resgates de fidelidade do Mercadinho São Miguel",
    rotas: ["/vendas", "/resgate", "/health"],
  });
});
